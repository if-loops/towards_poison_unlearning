...
# python visualize.py --tsvpath logs/ --dirpath ./results
...
def parse_args():
    ...
    parser.add_argument(
        "--dirpath", type=str, default="./logs/", help="root directory of saved results"
    )
    parser.add_argument(
        "--project_name",
        type=str,
...
if __name__ == "__main__":
    ...
    run_name = "debug" + str(args.p_cut)
    project_name_used = args.project_name  # + str(args.p_cut)
    wandb.init(project=f"{project_name_used}", name=f"{run_name}")
